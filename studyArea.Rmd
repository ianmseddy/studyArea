...
setPaths(modulePath = file.path("C:/Ian/temp"))
...
df_params <- SpaDES.core::moduleParams("studyArea", "C:/Ian/temp")
...
If `sourceURL` is specified, `downloadData("studyArea", "C:/Ian/temp")` may be sufficient.

```{r moduleInputs, echo = FALSE, eval = TRUE}
df_inputs <- SpaDES.core::moduleInputs("studyArea", "C:/Ian/temp")
...
df_outputs <- SpaDES.core::moduleOutputs("studyArea", "C:/Ian/temp")
